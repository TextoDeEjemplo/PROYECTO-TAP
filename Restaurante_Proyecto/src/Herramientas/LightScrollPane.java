...
public class LightScrollPane extends JComponent {
    ...
    Color Fondo = new Color(95, 95, 95  );
    
    Color bar = new Color(216, 216, 216 );
    
    Color borde = new Color(240, 240, 240);
    ...
    public LightScrollPane() 
    {
        ...
        verticalScrollBar.setBackground(bar);
        ...
        horizontalScrollBar.setBackground(bar);
